...
class BaseSegmentor(nn.Module):
    ...
    def __init__(self):
        ...
        normals_ = torch.randn(19,self.dim) * 1e-5
        ...
        offsets_ = torch.zeros(19,self.dim)
    ...
    def val_step(self, optimizer, data_batch, **kwargs):
        ...
        """
        output = self(optimizer,**data_batch, **kwargs)
        return output
